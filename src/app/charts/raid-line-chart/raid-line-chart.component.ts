...
@Component({
  selector: 'app-raid-line-chart',
  templateUrl: './raid-line-chart.component.html',
  styleUrls: ['./raid-line-chart.component.css']
})
export class RaidLineChartComponent implements OnInit {
